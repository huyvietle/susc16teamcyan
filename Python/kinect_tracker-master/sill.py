...
from kinect_capture import open_kinect, capture_images, threshold_depth_image
...
class Topologic(object):
    ...
    def get_contours(self):
        ...
        depth_image = capture_images(self.depth_stream, (self.w,self.h))
    ...
    def draw(self, screen):
        ...
        screen.blit(self.draw_surface, ((w-self.w)/2, (h-self.h)/2))
    ...
    def get_exterior(self, x, y, x1, x2, bottom, head_y):
         ...
         # find external blobs
         out_contours, out_hierarchy = cv2.findContours(intersection,cv2.RETR_TREE,cv2.CHAIN_APPROX_SIMPLE)
